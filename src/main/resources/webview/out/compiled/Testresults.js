var app = (function () {
	...
	/* src\main\resources\webview\components\Testresults.svelte generated by Svelte v4.2.18 */
	const file = "src\\main\\resources\\webview\\components\\Testresults.svelte";
	...
	function instance($$self, $$props) {
		...
		Object.keys($$props).forEach(key => {
			if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<Testresults> was created with unknown prop '${key}'`);
		});
