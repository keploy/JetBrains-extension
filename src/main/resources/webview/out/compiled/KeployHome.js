var app = (function () {
	...
	*/
	...
	/* src\main\resources\webview\components\KeployHome.svelte generated by Svelte v4.2.18 */

	const { console: console_1 } = globals;
	const file = "src\\main\\resources\\webview\\components\\KeployHome.svelte";
	...
	function create_else_block_1(ctx) {
		...
		const block = {
			c: function create() {
				...
				add_location(path0, file, 374, 95, 9953);
				...
				add_location(path1, file, 374, 195, 10053);
				attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
				attr_dev(svg, "width", "35px");
				attr_dev(svg, "height", "35px");
				attr_dev(svg, "viewBox", "0 0 24 24");
				add_location(svg, file, 374, 8, 9866);
			},
	...
	function create_if_block_6(ctx) {
		...
		const block = {
			c: function create() {
				...
				add_location(path, file, 372, 95, 9676);
				attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
				attr_dev(svg, "width", "35px");
				attr_dev(svg, "height", "35px");
				attr_dev(svg, "viewBox", "0 0 24 24");
				add_location(svg, file, 372, 8, 9589);
			},
			m: function mount(target, anchor) {
				insert_dev(target, svg, anchor);
				append_dev(svg, path);
	...
	function create_else_block(ctx) {
		...
		const block = {
			c: function create() {
				h1 = element("h1");
				t = text(t_value);
				attr_dev(h1, "class", "svelte-10v1v7g");
				add_location(h1, file, 394, 8, 11024);
			},
			m: function mount(target, anchor) {
	...
	function create_if_block_5(ctx) {
		...
		const block = {
			c: function create() {
				...
				attr_dev(h1, "class", "svelte-10v1v7g");
				add_location(h1, file, 392, 8, 10966);
			},
			m: function mount(target, anchor) {
				insert_dev(target, h1, anchor);
			},
	...
	function create_if_block_4(ctx) {
		...
		const block = {
			c: function create() {
				...
				attr_dev(h1, "class", "svelte-10v1v7g");
				add_location(h1, file, 390, 8, 10877);
			},
			m: function mount(target, anchor) {
				insert_dev(target, h1, anchor);
			},
	...
	function create_if_block_3(ctx) {
		...
		const block = {
			c: function create() {
				...
				add_location(h3, file, 417, 6, 12562);
				attr_dev(div, "id", "lastTestResults");
				add_location(div, file, 416, 4, 12529);
			},
			m: function mount(target, anchor) {
	...
	function create_if_block(ctx) {
		...
		const block = {
			c: function create() {
				...
				attr_dev(div, "class", "steps svelte-10v1v7g");
				add_location(div, file, 437, 4, 13707);
			},
			m: function mount(target, anchor) {
				insert_dev(target, div, anchor);
	...
	function create_each_block_1(ctx) {
		...
		const block = {
			c: function create() {
				...
				attr_dev(div, "class", "step svelte-10v1v7g");
				add_location(div, file, 444, 10, 13965);
			},
			m: function mount(target, anchor) {
				insert_dev(target, div, anchor);
			},
	...
	function create_each_block(ctx) {
		...
		const block = {
			c: function create() {
				...
				div.textContent = `${/*step*/ ctx[28]}`;
				attr_dev(div, "class", "step svelte-10v1v7g");
				add_location(div, file, 440, 10, 13842);
			},
			m: function mount(target, anchor) {
				insert_dev(target, div, anchor);
			},
	...
	function create_fragment(ctx) {
		...
		const block = {
			c: function create() {
				...
				t34 = space();
				div15 = element("div");
				attr_dev(span0, "class", "tooltip svelte-10v1v7g");
				add_location(span0, file, 370, 6, 9514);
				attr_dev(button0, "id", "keploycommands");
				attr_dev(button0, "class", button0_class_value = "icon-button " + (/*selectedIconButton*/ ctx[6] === 1 ? 'selected' : '') + " svelte-10v1v7g");
				add_location(button0, file, 369, 4, 9381);
				attr_dev(span1, "class", "history-icon");
				add_location(span1, file, 379, 6, 10455);
				attr_dev(span2, "class", "tooltip svelte-10v1v7g");
				add_location(span2, file, 380, 6, 10496);
				attr_dev(button1, "id", "displayPreviousTestResults");
				attr_dev(button1, "class", button1_class_value = "icon-button " + (/*selectedIconButton*/ ctx[6] === 2 ? 'selected' : '') + " svelte-10v1v7g");
				add_location(button1, file, 378, 4, 10310);
				attr_dev(span3, "class", "settings-icon");
				add_location(span3, file, 383, 6, 10680);
				attr_dev(span4, "class", "tooltip svelte-10v1v7g");
				add_location(span4, file, 384, 6, 10722);
				attr_dev(button2, "id", "openConfig");
				attr_dev(button2, "class", button2_class_value = "icon-button " + (/*selectedIconButton*/ ctx[6] === 3 ? 'selected' : '') + " svelte-10v1v7g");
				add_location(button2, file, 382, 4, 10551);
				attr_dev(div0, "class", "icon-buttons svelte-10v1v7g");
				add_location(div0, file, 368, 2, 9350);
				attr_dev(path0, "fill", "#FF914D");
				...
				add_location(path0, file, 397, 95, 11406);
				attr_dev(svg0, "xmlns", "http://www.w3.org/2000/svg");
				attr_dev(svg0, "width", "35px");
				attr_dev(svg0, "height", "35px");
				attr_dev(svg0, "viewBox", "0 0 24 24");
				add_location(svg0, file, 397, 8, 11319);
				attr_dev(span5, "class", "stop-button svelte-10v1v7g");
				attr_dev(span5, "id", "stopRecordingButton");
				attr_dev(span5, "role", "button");
				attr_dev(span5, "tabindex", "0");
				add_location(span5, file, 396, 6, 11138);
				attr_dev(path1, "fill", "#FF914D");
				...
				add_location(path1, file, 401, 95, 11859);
				attr_dev(svg1, "xmlns", "http://www.w3.org/2000/svg");
				attr_dev(svg1, "width", "35px");
				attr_dev(svg1, "height", "35px");
				attr_dev(svg1, "viewBox", "0 0 24 24");
				add_location(svg1, file, 401, 8, 11772);
				attr_dev(span6, "class", "stop-button svelte-10v1v7g");
				attr_dev(span6, "id", "stopTestingButton");
				attr_dev(span6, "role", "button");
				attr_dev(span6, "tabindex", "0");
				add_location(span6, file, 400, 6, 11595);
				attr_dev(div1, "class", "heading svelte-10v1v7g");
				add_location(div1, file, 388, 4, 10810);
				attr_dev(h30, "id", "recordStatus");
				attr_dev(h30, "class", "svelte-10v1v7g");
				add_location(h30, file, 405, 6, 12101);
				attr_dev(div2, "id", "recordedTestCases");
				attr_dev(div2, "class", "svelte-10v1v7g");
				add_location(div2, file, 406, 6, 12136);
				attr_dev(h31, "id", "testStatus");
				attr_dev(h31, "class", "svelte-10v1v7g");
				add_location(h31, file, 407, 6, 12177);
				attr_dev(div3, "id", "testResults");
				attr_dev(div3, "class", "svelte-10v1v7g");
				add_location(div3, file, 408, 6, 12210);
				attr_dev(button3, "id", "viewCompleteSummaryButton");
				attr_dev(button3, "class", "svelte-10v1v7g");
				add_location(button3, file, 409, 6, 12245);
				attr_dev(button4, "id", "viewTestLogsButton");
				attr_dev(button4, "class", "svelte-10v1v7g");
				add_location(button4, file, 410, 6, 12326);
				attr_dev(button5, "id", "viewRecordLogsButton");
				attr_dev(button5, "class", "svelte-10v1v7g");
				add_location(button5, file, 411, 6, 12383);
				attr_dev(hr, "id", "completeSummaryHr");
				attr_dev(hr, "class", "svelte-10v1v7g");
				add_location(hr, file, 412, 6, 12442);
				attr_dev(div4, "class", "statusdiv svelte-10v1v7g");
				attr_dev(div4, "id", "statusdiv");
				add_location(div4, file, 404, 4, 12056);
				attr_dev(div5, "class", "header svelte-10v1v7g");
				add_location(div5, file, 387, 2, 10785);
				...
				add_location(path2, file, 424, 95, 12974);
				...
				add_location(path3, file, 424, 195, 13074);
				attr_dev(svg2, "xmlns", "http://www.w3.org/2000/svg");
				attr_dev(svg2, "width", "35px");
				attr_dev(svg2, "height", "35px");
				attr_dev(svg2, "viewBox", "0 0 24 24");
				add_location(svg2, file, 424, 8, 12887);
				attr_dev(div6, "class", "card-icon svelte-10v1v7g");
				add_location(div6, file, 423, 6, 12855);
				attr_dev(div7, "class", "card-text svelte-10v1v7g");
				add_location(div7, file, 426, 6, 13244);
				attr_dev(div8, "class", "card-arrow svelte-10v1v7g");
				add_location(div8, file, 427, 6, 13297);
				attr_dev(div9, "class", "card svelte-10v1v7g");
				attr_dev(div9, "tabindex", "0");
				attr_dev(div9, "role", "button");
				attr_dev(div9, "id", "startRecordingButton");
				add_location(div9, file, 422, 4, 12660);
				attr_dev(div10, "class", "card-icon replay-icon svelte-10v1v7g");
				add_location(div10, file, 430, 6, 13531);
				attr_dev(div11, "class", "card-text svelte-10v1v7g");
				add_location(div11, file, 431, 6, 13579);
				attr_dev(div12, "class", "card-arrow svelte-10v1v7g");
				add_location(div12, file, 432, 6, 13632);
				attr_dev(div13, "class", "card svelte-10v1v7g");
				attr_dev(div13, "tabindex", "0");
				attr_dev(div13, "role", "button");
				attr_dev(div13, "id", "startTestingButton");
				add_location(div13, file, 429, 4, 13344);
				attr_dev(div14, "class", "section svelte-10v1v7g");
				attr_dev(div14, "id", "buttonsSection");
				add_location(div14, file, 421, 2, 12614);
				attr_dev(div15, "class", "loader svelte-10v1v7g");
				attr_dev(div15, "id", "loader");
				add_location(div15, file, 449, 2, 14045);
				attr_dev(div16, "class", "container baloo-2-custom svelte-10v1v7g");
				add_location(div16, file, 367, 0, 9309);
			},
			...
			p: function update(ctx, dirty) {
				...
				if (dirty[0] & /*selectedIconButton*/ 64 && button0_class_value !== (button0_class_value = "icon-button " + (/*selectedIconButton*/ ctx[6] === 1 ? 'selected' : '') + " svelte-10v1v7g")) {
					attr_dev(button0, "class", button0_class_value);
				}

				if (dirty[0] & /*selectedIconButton*/ 64 && button1_class_value !== (button1_class_value = "icon-button " + (/*selectedIconButton*/ ctx[6] === 2 ? 'selected' : '') + " svelte-10v1v7g")) {
					attr_dev(button1, "class", button1_class_value);
				}

				if (dirty[0] & /*selectedIconButton*/ 64 && button2_class_value !== (button2_class_value = "icon-button " + (/*selectedIconButton*/ ctx[6] === 3 ? 'selected' : '') + " svelte-10v1v7g")) {
